...
require.register("wooorm~retext-lancaster-stemmer@0.1.4", function (exports, module) {
'use strict';
...
stemmer = require('wooorm~lancaster-stemmer@0.1.2');
...
require.register("retext-lancaster-stemmer-gh-pages", function (exports, module) {
var lancasterStemmer = require('wooorm~retext-lancaster-stemmer@0.1.4'),
    visit = require('wooorm~retext-visit@0.2.2'),
    dom = require('wooorm~retext-dom@0.2.3'),
    Retext = require('wooorm~retext@0.3.0'),
    retext = new Retext().use(visit).use(lancasterStemmer).use(dom),
...
require("retext-lancaster-stemmer-gh-pages");
