...
var retext,
    retextWithLancasterStemmer;

retext = new Retext();
retextWithLancasterStemmer = new Retext().use(lancasterStemmer);
...
suite('retext w/o retext-lancaster-stemmer', function () {
...
suite('retext w/ retext-lancaster-stemmer', function () {
    bench('A paragraph (5 sentences, 100 words)', function (done) {
        retextWithLancasterStemmer.parse(paragraph, done);
    });

    bench('A section (10 paragraphs, 50 sentences, 1,000 words)',
        function (done) {
            retextWithLancasterStemmer.parse(section, done);
        }
    );
});
